...
export const MANUAL_FEATURES = [
  ...
  },
  {
    ...
    description: (
      <>
        <Paragraph>
          <strong>Connect with peers who learn like you.</strong> Discover users
          with similar learning paths and interests.
        <ul>
  ...
  },
  {
    ...
    description: (
      <>
        <Paragraph>
          <strong>Get started with ease.</strong> Create an account or log in
          to begin your IntelliPath journey.
        <ul>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <Tag color="green">AI Support</Tag> <Tag color="blue">Fast Learning</Tag>
      </>
    ),
  },
  {
